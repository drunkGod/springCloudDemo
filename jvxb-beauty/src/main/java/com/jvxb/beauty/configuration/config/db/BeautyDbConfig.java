package com.jvxb.beauty.configuration.config.db;
 ...
 */
@Configuration
@MapperScan(basePackages = {"com.jvxb.beauty.livable.mapper*"}, sqlSessionTemplateRef = "beautySqlSessionTemplate")
public class BeautyDbConfig {
    ...
    public SqlSessionFactory getSqlSessionFactory(@Qualifier("beautyDatasource") DataSource dataSource,
        ...
        sqlSessionFactory.setMapperLocations(new PathMatchingResourcePatternResolver()
                .getResources("com/jvxb/beauty/livable/mapper/xml/*Mapper.xml"));
