...
public class UserController {
    ...
    public RespMsg<List<User>> list(String name) {
        QueryWrapper wrapper = new QueryWrapper();
        wrapper.like(StrUtil.isNotEmpty(name), User.NAME, name);
    ...
    public RespMsg<IPage<User>> listPage(@RequestParam String name,
    ...
    public RespMsg<User> one(Integer id) {
    ...
    @PostMapping("add")
    @ApiOperation("测试新增")
    public RespMsg<User> add(User user) {
    ...
    @PostMapping("update")
    @ApiOperation("测试修改")
    public RespMsg<User> update(User user) {
